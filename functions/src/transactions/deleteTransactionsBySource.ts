...
interface DeleteTransactionsBySourceResponse {
  success: boolean;
  deleted: number;
}
...
export const deleteTransactionsBySourceCallable = createCallable<
  DeleteTransactionsBySourceRequest,
  DeleteTransactionsBySourceResponse
>(
  {
