...
exports.processOrphanedFiles = void 0;
const scheduler_1 = require("firebase-functions/v2/scheduler");
const firestore_1 = require("firebase-admin/firestore");
const matchFilePartner_1 = require("./matchFilePartner");
const matchFileTransactions_1 = require("./matchFileTransactions");
 ...
 */
async function processStuckAfterExtraction(staleTime) {
    ...
    const snapshot = await db
        ...
        .where("updatedAt", "<", firestore_1.Timestamp.fromDate(staleTime))
    ...
    for (const doc of snapshot.docs) {
        ...
        try {
            ...
            await (0, matchFilePartner_1.runPartnerMatching)(doc.id, data);
            processed++;
 ...
 */
async function processStuckAfterPartnerMatch(staleTime) {
    ...
    for (const doc of snapshot.docs) {
        ...
        try {
            ...
            await (0, matchFileTransactions_1.runTransactionMatching)(doc.id, data);
            processed++;
 ...
 */
exports.processOrphanedFiles = (0, scheduler_1.onSchedule)({
    ...
    console.log(`[Orphan] Completed. Partner: ${partnerProcessed}, Transaction: ${transactionProcessed}. Elapsed: ${elapsed}ms`);
});
//# sourceMappingURL=processOrphanedFiles.js.map