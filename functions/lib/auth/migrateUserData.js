...
exports.migrateUserData = (0, https_1.onCall)({
    ...
    if (callerEmail !== MIGRATION_EMAIL) {
        throw new https_1.HttpsError("permission-denied", "Only the designated admin can migrate data");
    }
    ...
    try {
        ...
        throw new https_1.HttpsError("internal", "Migration failed. Check logs for details.");
    }
});
/**
...
exports.checkMigrationStatus = (0, https_1.onCall)({
    ...
    try {
        ...
        throw new https_1.HttpsError("internal", "Failed to check migration status");
    }
});
