...
exports.triggerFileMatchingWorkerCallable = void 0;
 ...
 */
exports.triggerFileMatchingWorkerCallable = (0, createCallable_1.createCallable)({
    ...
    if (!fileDoc.exists) {
        throw new createCallable_1.HttpsError("not-found", `File ${fileId} not found`);
    }
    const fileData = fileDoc.data();
    // Check file ownership
    if (fileData.userId !== ctx.userId) {
        throw new createCallable_1.HttpsError("permission-denied", "Not authorized to access this file");
    }
...
//# sourceMappingURL=triggerFileMatchingWorker.js.map