...
exports.TWO_PHASE_THRESHOLD_BYTES = exports.DEFAULT_GEMINI_MODEL = void 0;
 ...
 */
async function extractFirstPage(fileBuffer, fileType) {
    if (fileType !== "application/pdf") {
        return fileBuffer;
    }
    try {
        const sourcePdf = await pdf_lib_1.PDFDocument.load(fileBuffer);
...
exports.TWO_PHASE_THRESHOLD_BYTES = 500 * 1024;
/**
 ...
 */
async function classifyDocument(fileBuffer, fileType, model = exports.DEFAULT_GEMINI_MODEL) {
...
JSON only, no markdown, no explanation.`;
    ...
    const additionalFields = (parsed.additionalFields || [])
