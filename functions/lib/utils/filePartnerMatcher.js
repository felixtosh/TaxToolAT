...
exports.matchFileToPartner = matchFileToPartner;
exports.matchFileToAllPartners = matchFileToAllPartners;
 ...
 */
function vatIdsMatch(vat1, vat2) {
    if (!vat1 || !vat2)
        return false;
    const normalize = (vat) => vat.toUpperCase().replace(/[^A-Z0-9]/g, "");
 ...
 */
function matchFileToPartner(file, partner, partnerType) {
    let bestMatch = null;
 ...
 */
function matchFileToAllPartners(file, userPartners, globalPartners) {
    const results = [];
...
//# sourceMappingURL=filePartnerMatcher.js.map